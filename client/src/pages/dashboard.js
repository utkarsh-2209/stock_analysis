    ...
    <div class="dashboard-page">
      ...
      <div class="dashboard-grid">
        ...
        <div class="left-column">
          ...
          <!-- Chart Prediction -->
          <div class="panel prediction-panel" style="margin-top: 20px;">
            <div class="panel-header">
              <span class="panel-title">🔮 AI Chart Prediction</span>
            </div>
            <div class="panel-body">
              <div class="upload-zone" id="upload-zone">
                ...
                <div class="upload-zone-text">
                  <strong>Upload</strong> a candlestick chart screenshot<br>
                  or drag & drop here
                </div>
              </div>
              ...
              <div id="prediction-loading" style="display:none;" class="page-loading">
                ...
                <div class="page-loading-text">Analyzing chart patterns...</div>
              </div>
...
function setupChartUpload(symbol) {
  ...
  predictBtn?.addEventListener('click', async () => {
    ...
    try {
      const stockContext = `${currentStockData?.longName || symbol} (${symbol}) - NSE India`;
      const prediction = await predictChart(base64Image, stockContext);
